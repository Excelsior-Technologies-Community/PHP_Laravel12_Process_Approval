...
<body>
    <div class="container">
        <div class="back-button">
            <a href="{{ route('approvals.show', $request->id) }}">← Back to Request</a>
        </div>
        ...
        <div class="card">
            ...
            <form action="{{ route('approvals.update', $request->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" id="description" rows="6" required>{{ old('description', $request->description) }}</textarea>
                </div>
